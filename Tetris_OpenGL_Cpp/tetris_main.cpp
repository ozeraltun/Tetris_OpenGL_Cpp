...
int main(int argc, char* argv[])
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "TETRIS By OzerAltun", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glfwPollEvents();
        if (!downpress) {
            timestepUpdate = Breakout.getTimeUpdate();
        }
        if (updatable) {
